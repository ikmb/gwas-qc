...
//    publishDir params.output, mode: 'copy'
    ...
    output:
    tuple file("${chrom}.filtered.vcf.gz"), file("${chrom}.filtered.vcf.gz.tbi"), val(chrom), val(filetype) into for_split_vcf, for_gen_r2, for_plink_imp
...
output:
    file("pcs") into for_draw_pcs, for_saige_covars
