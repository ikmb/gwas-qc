...
plot(fdr, fdr.hf$Fail_worstbatchremoved_ctrls/1000, xlim=c(1,10), ylim=c(0,200), xlab="-log10(FDR threshold)", ylab="# SNPs failed (x 1,000)", pch=17, col="black", type="b", yaxt="n", xaxt="n", cex=1.5)
lines(fdr, fdr.hf$Fail_allbatches_ctrls/1000, type="b", pch=20, col="black", cex=1.5)
...
text(fdr[FDR_index_remove_variants], fdr.hf$Fail_worstbatchremoved_ctrls[FDR_index_remove_variants]/1000, labels=c(fdr.hf$Fail_worstbatchremoved_ctrls[FDR_index_remove_variants]/1000), pos=4)
