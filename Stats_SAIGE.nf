...
process stage_plink_intermediates {
    ...
    file "*.genotyped.imputed.rsq0.3.chr1-22.{bed,bim,fam}" into for_generate_sumstats_ds, for_clumping_ds
...
output:
    file "${stats}.l95u95" into for_clumping_l95u95
...
<"!{stats}" mawk '{ print $20, $13 }' >p.or.tmp1
